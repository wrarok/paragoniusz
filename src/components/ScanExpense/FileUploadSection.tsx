...
export function FileUploadSection({ onUpload, isUploading, error }: FileUploadSectionProps) {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>Prześlij zdjęcie paragonu, aby automatycznie wyodrębnić dane o wydatkach</CardDescription>
      </CardHeader>
          ...
          <div className="flex flex-col items-center gap-4">
            {selectedFile ? (
              ...
              <>
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium">Upuść paragon tutaj lub kliknij, aby przeglądać</p>
                  <p className="text-xs text-muted-foreground">JPEG, PNG lub HEIC do 10MB</p>
                </div>
              </>
            )}
          </div>
