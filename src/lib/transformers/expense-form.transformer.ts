...
export class ExpenseFormTransformer {
  /**
   ...
   */
  static toCreateCommand(formData: ExpenseFormValues): CreateExpenseCommand {
    return {
   ...
   */
  static toUpdateCommand(formData: ExpenseFormValues): UpdateExpenseCommand {
    return {
      category_id: formData.category_id,
      amount: parseFloat(formData.amount),
      expense_date: formData.expense_date,
   ...
   */
  static fromDTO(dto: ExpenseDTO): ExpenseFormValues {
    return {
