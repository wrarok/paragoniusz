    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          category: {
            type: 'string',
            description: 'Category name - must be one of: żywność, transport, media, rozrywka, zdrowie, edukacja, odzież, restauracje, mieszkanie, ubezpieczenia, higiena, prezenty, podróże, subskrypcje, inne',
            enum: ['żywność', 'transport', 'media', 'rozrywka', 'zdrowie', 'edukacja', 'odzież', 'restauracje', 'mieszkanie', 'ubezpieczenia', 'higiena', 'prezenty', 'podróże', 'subskrypcje', 'inne']
          },
        },
