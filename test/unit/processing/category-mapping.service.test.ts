...
describe("CategoryMappingService", () => {
  ...
  describe("mapExpensesWithCategories()", () => {
    it("should map single item to exact matching category", async () => {
      // Arrange
      const items = [{ name: "Jabłka", amount: 5.99, category: "Jedzenie" }];
      const dbCategories = [
    ...
    it("should group multiple items with same category", async () => {
      ...
      const items = [
        ...
        { name: "Chleb", amount: 4.5, category: "Jedzenie" },
      ];
    ...
    it("should handle multiple different categories", async () => {
      ...
      const items = [
        ...
        { name: "Bilet autobusowy", amount: 4.5, category: "Transport" },
      ];
      const dbCategories = [
        { id: "cat-1", name: "Jedzenie" },
        { id: "cat-2", name: "Transport" },
    ...
    it("should match when DB category contains AI category name", async () => {
      // Arrange
      const items = [{ name: "Item", amount: 10, category: "Jedzenie" }];
      const dbCategories = [
    ...
    it('should fallback to "Inne" category when no match found', async () => {
      // Arrange
      const items = [{ name: "Item", amount: 10, category: "UnknownCategory" }];
      const dbCategories = [
        { id: "cat-1", name: "Jedzenie" },
        { id: "cat-2", name: "Transport" },
    ...
    it("should format amounts with 2 decimal places", async () => {
      ...
      expect(result[0].items).toEqual(["Item 1 - 5.00", "Item 2 - 3.50", "Item 3 - 1.12"]);
    });
    ...
    it("should handle Polish category names with special characters", async () => {
      // Arrange
      const items = [{ name: "Item", amount: 10, category: "Żywność" }];
      const dbCategories = [{ id: "cat-1", name: "Żywność" }];
    ...
    it("should preserve item order within category", async () => {
      ...
      // Assert
      expect(result[0].items).toEqual(["First - 1.00", "Second - 2.00", "Third - 3.00"]);
    });

    it("should handle zero amounts", async () => {
      // Arrange
      const items = [{ name: "Free item", amount: 0, category: "Test" }];
      const dbCategories = [{ id: "cat-1", name: "Test" }];
    ...
    it("should handle large amounts", async () => {
      // Arrange
      const items = [{ name: "Expensive item", amount: 999999.99, category: "Test" }];
      const dbCategories = [{ id: "cat-1", name: "Test" }];
    ...
    it("should prefer exact match over partial match", async () => {
      // Arrange
      const items = [{ name: "Item", amount: 10, category: "Transport" }];
      const dbCategories = [
    ...
    it("should handle real-world receipt scenario", async () => {
      ...
      const items = [
        { name: "Chleb", amount: 3.5, category: "Pieczywo" },
        { name: "Mleko", amount: 4.2, category: "Nabiał" },
        { name: "Ser żółty", amount: 12.99, category: "Nabiał" },
        { name: "Jabłka", amount: 5.99, category: "Owoce i warzywa" },
        { name: "Ziemniaki", amount: 3.5, category: "Owoce i warzywa" },
      ];
      const dbCategories = [
